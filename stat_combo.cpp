...
//pie chart
    ...
    q1.prepare("SELECT * FROM LABORATOIRES");
    q1.exec();

    q2.prepare("SELECT * FROM LABORATOIRES WHERE SPECIALITE='s1'");
    q2.exec();

    q3.prepare("SELECT * FROM LABORATOIRES WHERE SPECIALITE='s2'");
    q3.exec();

    q4.prepare("SELECT * FROM LABORATOIRES WHERE SPECIALITE='s3' ");
    q4.exec();
